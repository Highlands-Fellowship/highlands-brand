...
```json
{
  ...
  "color_system": {
    "palette": {
      "primary":   // Navy Blue (#0b1d41) — main brand color, 3 tones, RGB, text_on
      "secondary": // Teal (#55b6b2) — accents, icon fills, logo backgrounds, 3 tones
      "accent":    // Yellow (#F5B731) — accent text and callouts, used sparingly
...
- **Primary color:** Navy Blue `#0b1d41`
- **Secondary color:** Teal `#55b6b2`
- **Accent color:** Yellow `#F5B731` (text/callout use only — sparingly)
